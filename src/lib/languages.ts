...
export const content: Record<Language, LanguageContent> = {
  ...
  lo: {
    ...
    heroText: "ແພລດຟອມທີ່ຊ່ວຍໃຫ້ການສະໝັກວຽກອອນລາຍເປັນເລື່ອງງ່າຍ ແລະ ໄວ ຄົ້ນຫາໂອກາດໃໝ່ໆ ແລະ ເຕີບໂຕໃນສາຍອາຊີບຂອງທ່ານກັບພວກເຮົາ",
    ...
    step1Desc: "ສ້າງໂປຣໄຟລ໌ສ່ວນຕົວ ແລະ ອັບໂຫລດປระวัติການເຮັດວຽກ",
    step2Title: "ຄົ້ນຫາວຽກ",
    step2Desc: "ຄົ້ນຫາຕຳແໜ່ງວຽກທີ່ເໝາະສົມກັບທັກສະ ແລະ ປະສົບການ",
    step3Title: "ສະໝັກວຽກ",
    step3Desc: "ສົ່ງໃບສະໝັກວຽກດ້ວຍຄລິກດຽວ ພ້ອມຕິດຕามສະຖານະ",
    step4Title: "ສຳພາດວຽກ",
    step4Desc: "ຮັບການຕິດຕໍ່ຈາກບໍລິສັດເພື່ອສຳພາດວຽກ ແລະ ເລີ່ມຕົ້ນອາຊີບໃໝ່",
    videoTitle: "ດູວິດີໂອແນະນຳການໃຊ້ງານ",
    videoDesc: "ຮຽນຮູ້ວິທີການໃຊ້ງານ Rise Career ຢ່າງລະອຽດ",
    aboutTitle: "ກ່ຽວກັບ Rise Career",
    aboutDesc: "Rise Career ເປັນແພລດຟອມສະໝັກວຽກອອນລາຍທີ່ມຸ່ງໝັ້ນໃນການເຊື່ອມຕໍ່ລະຫວ່າງຜູ້ຫາວຽກ ແລະ ບໍລິສັດຊັ້ນນຳ ໃນການຊ່ວຍໃຫ້ຜູ້ຄົນຄົ້ນຫາອາຊີບี່ເໝາະສົມ",
    ...
    blog1Title: "ເທັກນິກການຂຽນ Resume ໃຫ້ດອນໃຈ HR",
    ...
    viewAllPosts: "ດູໂພສທັງໝົດຈາກ Facebook",
    faqTitle: "ຄຳຖາມທີ່ພົບບ່ອນ",
    ...
    subscribe: "ສະໝັກ",
    newsletterNote: "ພວກເຮົາຈະບໍ່ສ່ງອີເມວຂີດຂີ້ໃຫ້ທ່ານ ສາມາດຍົກເລີກກารสມัครได้ທุກເວລາ",
    services: "ບໍລິການ",
